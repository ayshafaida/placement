...
class ApplyRejectedPage extends StatefulWidget {
  const ApplyRejectedPage({super.key});

  @override
  State<ApplyRejectedPage> createState() => _ApplyRejectedPageState();
}

class _ApplyRejectedPageState extends State<ApplyRejectedPage> {
  String? username;
  @override
  void initState() {
  ...
  void callApliedjob() async {
    ...
    ApiService().applyjoblist = ApiService().fetchapplyJobs("2");
  }
